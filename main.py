...
from bs4 import BeautifulSoup # A beginner-friendly HTML parser that creates a parse tree for easy data extraction. It works seamlessly with content fetched using Requests.
from selenium import webdriver # Automates a real browser, enabling scraping of dynamic, JavaScript-loaded websites. It is slower than other tools and less suitable for large-scale scraping.
...
# Note: I had to change the imports a lot because the original site is outdated. agh. 
